...
> The functions of the respective weighted rating algorithms (Bayesian Average, Wilson Score Interval,
> Bradley-Terry-Luce Model, and Dirichlet–Multinomial Model) were generated by ChatGPT (GPT-5 > model),
> adapted and later amended by Melvin to serve applicable and practical for dataset analysis.
